...
def create_appointment():
    ...
    return jsonify(map_db_appointment_to_response_appointment(db_appointment).dict())
...
def read_appointments():
    ...
    return jsonify([map_db_appointment_to_response_appointment(appointment).dict() for appointment in appointments])
